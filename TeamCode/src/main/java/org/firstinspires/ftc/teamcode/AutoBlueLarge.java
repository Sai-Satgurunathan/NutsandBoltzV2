...
@Autonomous(name="Back2LaunchLeft90Forward2Auto", group="StarterBot")
public class AutoBlueLarge extends OpMode {
    ...
    public void loop() {
        switch (autoState) {
            ...
            case ROTATE_LEFT_90:
                // Left 90 degrees -> negative angle in this implementation (positive = right)
